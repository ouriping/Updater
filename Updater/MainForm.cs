...
namespace Updater
{
    public partial class MainForm : Form
    {
        ...
        private Core.UpdateClass updater;
        private List<Core.Manifest> mList = new List<Core.Manifest>();
        private int mLen = 0;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                updater = new Core.UpdateClass();
                updater.ActivationCompleted += new EventHandler<Core.ActivationCompletedEventArgs>(ActivationCompleted);
                updater.ActivationError += new EventHandler<Core.FileCopyErrorEventArgs>(ActivationError);
                updater.ActivationInitializing += new EventHandler<Core.ManifestEventArgs>(ActivationInitializing);
                updater.ActivationProgressChanged += new EventHandler<Core.FileCopyProgressChangedEventArgs>(ActivationProgressChanged);
                updater.ActivationStarted += new EventHandler<Core.ActivationStartedEventArgs>(ActivationStarted);
                updater.DownloadCompleted += new EventHandler<Core.DownloadCompleteEventArgs>(DownloadCompleted);
                updater.DownloadError += new EventHandler<Core.DownloadErrorEventArgs>(DownloadError);
                updater.DownloadProgressChanged += new EventHandler<Core.DownloadProgressEventArgs>(DownloadProgressChanged);
        ...
        void DownloadProgressChanged(object sender, Core.DownloadProgressEventArgs e)
        {
        ...
        void DownloadError(object sender, Core.DownloadErrorEventArgs e)
        {
        ...
        void DownloadCompleted(object sender, Core.DownloadCompleteEventArgs e)
        {
        ...
        void ActivationStarted(object sender, Core.ActivationStartedEventArgs e)
        {
        ...
        void ActivationProgressChanged(object sender, Core.FileCopyProgressChangedEventArgs e)
        {
            progressBar1.Value = e.ProgressPercentage;
            lab_percent.Text = e.ProgressPercentage.ToString() + "%";
            lab_percent.Update();
        ...
        void ActivationInitializing(object sender, Core.ManifestEventArgs e)
        {
        ...
        void ActivationError(object sender, Core.FileCopyErrorEventArgs e)
        {
        ...
        void ActivationCompleted(object sender, Core.ActivationCompletedEventArgs e)
        {
            //安装完成
            isComplete = true;
